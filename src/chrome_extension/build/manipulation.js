...
(async () => {
  await setTimeout(async () => {
    ...
    const { isFelixActive } = await chrome.storage.local.get(["isFelixActive"]);
    ...
    console.table("isFelixActive:", isFelixActive);
...
const felixNotification = async () => {
  ...
  felixActiveDiv.innerHTML = "🔔  Felix manupulated images";
